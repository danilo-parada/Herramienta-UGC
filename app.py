...
PHASES = [
    ...
    },
    {
        ...
        "summary": "Evaluar la capacidad tecnológica y factores críticos del negocio para el proyecto",
        "detail": (
            "Integra resultados de IRL y EBCT para generar un diagnóstico estratégico. Identifica brechas críticas, analiza el panorama de madurez y proporciona recomendaciones para mejorar capacidades."
        ),
        "outputs": ["Evaluación de capacidades", "Análisis de factores críticos", "Recomendaciones estratégicas"]
    },
    {
        "title": "Fase 4",
        "icon": "📈",
        "subtitle": "Indicadores",
        "summary": "Sistema de gestión y monitoreo de indicadores de desempeño de proyectos de innovación",
        "detail": (
            "Integra datos en paneles individuales y generales para apoyar decisiones estratégicas. Monitorea el portafolio y desempeño de cada proyecto con visualizaciones interactivas que permiten análisis por proyecto o comparaciones entre proyectos."
        ),
...
if fase0_page:
    ...
    with col2:
        if st.button("📂 Ir a Fase 0", type="primary", use_container_width=True):
